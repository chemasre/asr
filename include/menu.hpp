...
#define MENU_TITLE_COLOR MAKE_COLOR(255,255,255)
#define MENU_WINDOW_COLOR MAKE_COLOR(67,227,67)
#define MENU_OPTION_COLOR MAKE_COLOR(67,227,67)
#define MENU_OPTION_SELECTED_COLOR MAKE_COLOR(249,227,79)
